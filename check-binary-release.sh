...
ASTERIX_VERSION=0.9.8
HYRACKS_VERSION=0.3.8

BASENAME=asterix-server-$ASTERIX_VERSION
RELEASENAME=apache-asterixdb-$ASTERIX_VERSION
ARCHIVENAME=$BASENAME-binary-assembly
SHA512=59be971936c83c1c035a04f7c01a46bdd71f21d2b2117493039f1f45a385d7e8b7f38b3da0bce06f7fb504e846b699f977205b2375e44fbc76a4d3cb320ddea0
